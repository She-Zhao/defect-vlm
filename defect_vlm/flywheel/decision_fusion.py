...
if __name__ == "__main__":
    ...
    # 配置你的文件路径
    json_col3 = "/data/ZS/flywheel_dataset/2_yolo_preds/iter0/sp012_col3_0p1.json"
    json_row3 = "/data/ZS/flywheel_dataset/2_yolo_preds/iter0/sp012_row3_0p1.json"
    output_json = "/data/ZS/flywheel_dataset/2_yolo_preds/iter0/sp012_decision_fusion_0p1.json"
