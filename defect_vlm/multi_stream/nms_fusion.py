...
if __name__ == '__main__':
    ...
    COL3_JSON = "/data/ZS/flywheel_dataset/10_semi_yolo_preds/iter0/col3.json"
    ROW3_JSON = "/data/ZS/flywheel_dataset/10_semi_yolo_preds/iter0/row3.json"
    FUSION_JSON = "/data/ZS/flywheel_dataset/10_semi_yolo_preds/iter0/nms_fusion.json"
