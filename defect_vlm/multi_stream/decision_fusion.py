...
if __name__ == "__main__":
    ...
    config = {
        ...
        'AREA_TH': 0.5,             # 尺度感知面积阈值 (th)，以6*6像素为分界线
    ...
    output_json = "/data/ZS/defect_dataset/9_yolo_preds/val_official/decision_fusion1.json"
    
    # json_col3 = "/data/ZS/flywheel_dataset/10_semi_yolo_preds/iter0/col3.json"
    # json_row3 = "/data/ZS/flywheel_dataset/10_semi_yolo_preds/iter0/row3.json"
    # output_json = "/data/ZS/flywheel_dataset/10_semi_yolo_preds/iter0/decision_fusion.json"
