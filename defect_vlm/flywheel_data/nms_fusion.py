...
输入：
/data/ZS/flywheel_dataset/2_yolo_preds/val_0p1/col3_iter0.json
/data/ZS/flywheel_dataset/2_yolo_preds/val_0p1/row3_iter0.json
输出：
...
if __name__ == '__main__':
    # 配置文件路径
    COL3_JSON = "/data/ZS/flywheel_dataset/2_yolo_preds/iter0_0p1/sp123_col3.json"
    ROW3_JSON = "/data/ZS/flywheel_dataset/2_yolo_preds/iter0_0p1/sp123_row3.json"
    FUSION_JSON = "/data/ZS/flywheel_dataset/2_yolo_preds/iter0_0p1/sp123_fusion.json"
