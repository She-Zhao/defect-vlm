...
if __name__ == "__main__":
    ...
    input_path = '/data/ZS/flywheel_dataset/5_vlm_message/iter0/sp123_0p1.jsonl'            # 修改
    model_path = 'Qwen/Qwen3-VL-4B-Instruct'
    output_path = '/data/ZS/flywheel_dataset/6_vlm_response/iter0/sp123_0p1_v1_LM.jsonl'    # 修改
